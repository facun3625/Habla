...
export default function EditPostPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  if (loading) return <AdminLayout><p style={{ padding: '2rem' }}>Cargando noticia...</p></AdminLayout>;
        ...
        <div className={styles.tableCard} style={{ padding: '30px' }}>
          <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: '20px' }}>
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: '10px', marginTop: '10px' }}>
              ...
              />
              <label htmlFor="published" style={{ fontWeight: 600, cursor: 'pointer' }}>Publicada</label>
            </div>
